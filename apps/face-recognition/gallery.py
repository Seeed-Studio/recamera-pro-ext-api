...
FORMAT_VERSION = 2
DEFAULT_DIR = "/userdata/local/appdata/face-recognition/gallery"
...
def default_path(model_tag: str) -> str:
    ...
    appdata = os.environ.get("APPMGR_APPDATA_DIR", "/userdata/local/appdata")
    base = os.environ.get("FACE_GALLERY_DIR") or os.path.join(
        appdata, "face-recognition", "gallery")
